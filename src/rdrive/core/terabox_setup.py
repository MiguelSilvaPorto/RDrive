...
_FORK_HINT_PT = (
    ...
    "Instale um build não oficial com suporte TeraBox (ex.: "
    "https://github.com/x1arch/rclone/tree/backend/terabox ou rclone-extra) "
    "e confirme com: rclone help backends | findstr terabox"
)

_COOKIE_HELP_PT = (
    "1. Inicie sessão em https://www.terabox.com no browser.\n"
    "2. F12 → Rede → atualize a página → escolha um pedido a terabox.com.\n"
    "3. Copie o cabeçalho «Cookie» completo, ou apenas o valor de «ndus=…».\n"
    "4. Cole abaixo e volte a «Ligar TeraBox»."
)

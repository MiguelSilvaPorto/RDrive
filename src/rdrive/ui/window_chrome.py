...
from rdrive.ui.app_icon import apply_window_icon, title_bar_pixmap
from rdrive.ui.theme import (
    CHROME_TOKENS,
    THEME_BG,
    TOOLBAR_MIN_HEIGHT,
...
class CustomTitleBar(QWidget):
    ...
    def __init__(self, window: QWidget, title: str) -> None:
        ...
        self._icon_label.setObjectName("customTitleIcon")
        pix = title_bar_pixmap()
        if not pix.isNull():
            self._icon_label.setPixmap(pix)
            self._icon_label.setFixedSize(pix.size())
        else:

...
from rdrive.core.cloud.remote_setup import display_name_for_backend, is_user_facing_provider
from rdrive.ui.widgets.provider_icons import CARD_ICON_SIZE, provider_pixmap
...
def _normalize_provider_entries(
    ...
    for entry in providers:
        ...
        if not slug or not is_user_facing_provider(slug):
            continue
        key = _normalize_slug(slug)
